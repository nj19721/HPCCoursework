...
float reboundCollisionAVVels(const t_param params, t_speed* cells, t_speed* tmp_cells, int* obstacles);
...
float timestep(const t_param params, t_speed* cells, t_speed* tmp_cells, int* obstacles)
{
  ...
  return reboundCollisionAVVels(params, cells, tmp_cells, obstacles);
}
